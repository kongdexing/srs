...
DEPAS=gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=/home/dexing/srs/srs-csdn/trunk/objs/ffmpeg.src/_release/bin/yasm
DEPYASM=/home/dexing/srs/srs-csdn/trunk/objs/ffmpeg.src/_release/bin/yasm
AR=ar
ARFLAGS=rc
AR_O=$@
RANLIB=ranlib
...
LD_PATH=-L
DLLTOOL=
LDFLAGS= -L/home/dexing/srs/srs-csdn/trunk/objs/ffmpeg.src/_release/lib -lm -ldl  -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
EXTRALIBS=-lx264 -lspeex -lmp3lame -lfdk-aac -lm -lbz2 -lz -lpthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
